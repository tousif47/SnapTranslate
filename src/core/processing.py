...
async def process_image_and_translate(image: Image.Image, target_language: str = 'en') -> str:
    """
    ...
    if extracted_text:
        translated_text = await translator.translate_text(extracted_text, dest_lang=target_language)
